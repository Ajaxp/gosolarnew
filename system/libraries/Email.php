...
class CI_Email {
	...
	var	$smtp_host		= "smtp.1and1.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "devang.naghera@agileinfoways.com";		// SMTP Username
	var	$smtp_pass		= "devang007@#";		// SMTP Password
